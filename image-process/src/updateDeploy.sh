...
echo "3. uploading functions to OpenWhisk..."
    ...
    wsk action update transformMetadata  transform-metadata/target/transform-metadata.jar --main org.serverlessbench.TransformMetadata --docker openwhisk/java8action -i  -m $loop
